...
class MB_LE(object):
    ...
    def __init__(self, dvs_input, sim_t, w_kc2kc=0):
        ...
        self.pns = sim.Population(nb_pn , sim.IF_cond_exp(tau_m = 50.0) , label = "PN")
        self.kcs = sim.Population(nb_kc , sim.IF_cond_exp(tau_m = 50.0) , label = "KC")
        self.kcs_a = sim.Population(nb_kc , sim.IF_cond_exp(tau_m = 50.0) , label = "KC_A")
        self.ens = sim.Population(nb_en , sim.IF_cond_exp(tau_m = 50.0) , label = "EN")
        self.ens_a = sim.Population(nb_en , sim.IF_cond_exp(tau_m = 50.0) , label = "EN_A")
